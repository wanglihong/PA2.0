...
@property (nonatomic, retain, getter = get_realName) NSString *peopleRealName;
@property (nonatomic, retain, getter = get_nickName) NSString *peopleNickName;
...
@property (nonatomic, retain, getter = get_email) NSString *peopleEmail;
